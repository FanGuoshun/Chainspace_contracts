...
//        return System.getProperty("checker.python.bin", "../.chainspace.env/bin/python");
          return System.getProperty("checker.python.bin", "/home/aaron/project/python2_env/env/bin/python");
          //实际运行时，将getProperty方法的第二个参数改为自己电脑上的python虚拟环境目录，如$PATH_TO_VIRTUAL_ENV$/bin/python
    ...
    PythonChecker(String contractID) throws StartCheckerException {
        ...
        this.pythonScriptPath = "PythonContracts/" + contractID + ".py";
